...
CREATE TABLE `account_lockouts` (
  ...
  `reason` varchar(100) DEFAULT 'intentos_fallidos',
  `unlock_code` varchar(6) DEFAULT NULL,
  `unlock_code_expires` timestamp NULL DEFAULT NULL,
  ...
  CONSTRAINT `account_lockouts_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Bloqueos temporales de cuenta';
...
INSERT INTO `campeonatos` VALUES (1,'Campeonato Barrial 2025','Campeonato de fútbol nacional','2025-01-15','2026-03-31','planificacion',2,'2025-10-19 23:44:47'),(2,'Liga 2025','Campeonato de verano','2025-01-01','2025-06-30','planificacion',2,'2025-10-21 05:42:15');
...
INSERT INTO `equipos` VALUES (1,'Barcelona FC',NULL,1,'2025-10-21 06:15:23','2025-10-21 06:23:01','aprobado','Documentación completa y verificada',2);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Registro de intentos de login';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `password_reset_tokens` (
  ...
  CONSTRAINT `password_reset_tokens_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tokens para recuperar contraseña';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Control de tasa de peticiones';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `refresh_tokens` (
  ...
  KEY `idx_user` (`user_id`),
  KEY `idx_expires` (`expires_at`),
  CONSTRAINT `refresh_tokens_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tokens de actualización';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `security_logs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `event_type` enum('login_success','login_failed','logout','password_changed','account_locked','account_unlocked','token_revoked','suspicious_activity') NOT NULL,
  ...
  CONSTRAINT `security_logs_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`id_usuario`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Auditoría de eventos de seguridad';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `token_blacklist` (
  ...
  KEY `idx_expires` (`expires_at`),
  KEY `idx_user` (`user_id`),
  CONSTRAINT `token_blacklist_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tokens JWT revocados';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuarios` VALUES (1,'Administrador','admin@campeonato.com',0,NULL,'$2b$12$3OxDX9PKf9fuWFhlhXsVYu5ORBLcARZNJFCcLKyfy0JY/jBFFbRXG',NULL,'admin',1,0,NULL,'2025-10-11 00:18:42','2025-10-11 00:18:42',NULL,NULL),(2,'Administrador principal','cesar_Ramos@campeonato.com',0,NULL,'$2b$12$Oglcba.dxU/Yzx.HKPqrGOvTaw/afPZjtaeI7yXfzN0LQRi1qzROm',NULL,'admin',1,0,NULL,'2025-10-19 00:42:50','2025-10-19 00:42:50',NULL,NULL),(3,'Daniel Ramos','daniel@campeonato.com',0,NULL,'$2b$12$LtrS.dUs31PX3M7K90qILuOICQUAhFMWa6RSg6Qg9uNqpsEkbO0sq',NULL,'lider',1,0,NULL,'2025-10-19 00:44:57','2025-10-19 00:44:57',NULL,NULL);
...
-- Dump completed on 2025-10-25  9:18:26
